...
int num_slice = 1;
int slice_size = num_rows * num_cols;	///< each slice(2D) size of a 3D NoC
int num_tiles = num_rows * num_cols * num_slice;	///< number of tiles in topology
int cluster_size = 16;			/// for C_Routing
int num_clusters = num_tiles/cluster_size; /// for C-Routing
...
float EPSILON = .5;	// probability if choosing random destination.
float ALPHA = .8;
ULL QXY_SIMCOUNT = 0;
UI ESTBUF = 10;
UI WAITS = 100;
