...
OTHER  = -Wall
LDFLAG = -rdynamic
LPERMFLAG = -fpermissive

#CFLAGS = $(DEBUG) $(OTHER) $(LDFLAG)
CFLAGS = $(DEBUG) $(LDFLAG) $(LPERMFLAG)
...
ROUTER_SRCS = \
	...
	router/src/ZXY_router.cpp \
	router/src/C_router.cpp \
	router/src/PROM2D_router.cpp\
	router/src/PROM3D_router.cpp \
	router/src/NL_router.cpp\
	router/src/WF_router.cpp\
	router/src/FTXYZ_router.cpp \
	router/src/OddEven3D_router.cpp
