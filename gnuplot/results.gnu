...
#------------------------------------------------------------------------------------------------
#added for LinkUsage
# Links used at a tile
reset
set term postscript eps enhanced color
set pm3d
#set border 4095
set output "results/graphs/LinkUsage"
set xlabel "Routers along X-direction"
set ylabel "Routers along Y-direction"
#set zlabel "LinkUsage(in number count)" center rotate by 90
set title "Number of times links used at tiles (integer count)"
set label "tile-0" at 0.2,0.1
set ticslevel 0
set hidden3d
