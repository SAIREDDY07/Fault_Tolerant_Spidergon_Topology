...
//////////////////////////////////////////////////////////////////////////
template<UI num_op = NUM_OC_B>
//template<UI num_op = NUM3D_OC>
struct InputChannel : public sc_module {
	...
	void setTileID(UI tileID, UI portN, UI portS, UI portE, UI portW, UI portF, UI portR);	// function overloaded for 3D topology.
	...
	UI	portF;		///< port number representing Front output direction
	UI	portR;		///< port number representing Rear output direction
