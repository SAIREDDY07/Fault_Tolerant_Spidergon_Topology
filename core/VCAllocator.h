...
struct VCAllocator : public sc_module {
	...
	sc_in<sc_uint<3> > opRequest[num_ip];			///< input ports to recieve output channel requested from ICs
	...
	void setTileID(UI tileID, UI portN, UI portS, UI portE, UI portW, UI portF, UI portR);	//for  3D topology
